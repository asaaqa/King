...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/asaaqa/King"
    )
    # External plugins repo
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/asaaqa/CatPlugins"
    else:
        EXTERNAL_REPO = None
    ...
    BADCAT_REPO = os.environ.get("BADCAT_REPO", "https://github.com/asaaqa/CatPlugins")
    if BADCAT_REPO and not url(BADCAT_REPO):
        BADCAT_REPO = "https://github.com/asaaqa/CatPlugins"
